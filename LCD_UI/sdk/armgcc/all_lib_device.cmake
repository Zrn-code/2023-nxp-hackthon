...
#  # description: Generic HAL Cortext M
#  set(CONFIG_USE_component_gen_hal_arch_cortexm true)
...
#  # description: RT106x GH SoC Specific Files
#  set(CONFIG_USE_component_gen_hal_soc_MIMXRT1062 true)

#  # description: GH dma Driver
#  set(CONFIG_USE_component_gen_hal_driver_dma true)

#  # description: GH ADC Driver
#  set(CONFIG_USE_component_gen_hal_driver_adc true)

#  # description: GH Pin control Driver
#  set(CONFIG_USE_component_gen_hal_driver_pinctrl true)

#  # description: GH uart Driver
#  set(CONFIG_USE_component_gen_hal_driver_uart true)

#  # description: GH clock_control Driver
#  set(CONFIG_USE_component_gen_hal_driver_clock_control true)

#  # description: GH gpio Driver
#  set(CONFIG_USE_component_gen_hal_driver_gpio true)

#  # description: GH counter Driver
#  set(CONFIG_USE_component_gen_hal_driver_counter true)

#  # description: GH i2c Driver
#  set(CONFIG_USE_component_gen_hal_driver_i2c true)

#  # description: GH spi Driver
#  set(CONFIG_USE_component_gen_hal_driver_spi true)

#  # description: GH uart Driver lpuart
#  set(CONFIG_USE_component_gen_hal_driver_uart_lpuart true)

#  # description: GH clock_control Driver ccm
#  set(CONFIG_USE_component_gen_hal_driver_clock_control_ccm true)

#  # description: GH clock_control Driver syscon
#  set(CONFIG_USE_component_gen_hal_driver_clock_control_syscon true)

#  # description: GH ADC Driver variant of ADC 12B1MSPS_SAR
#  set(CONFIG_USE_component_gen_hal_driver_adc_adc_12b1msps_sar true)

#  # description: Generic HAL pinctrl variant imxrt driver
#  set(CONFIG_USE_component_gen_hal_driver_pinctrl_imxrt true)

#  # description: Generic HAL CM7 Support
#  set(CONFIG_USE_component_gen_hal_arch_cm7 true)

#  # description: Generic HAL CM33 Support
#  set(CONFIG_USE_component_gen_hal_arch_cm33 true)
...
#set.component.gen_hal
#  # description: Basic Files/Path for Generic HAL. Needed by each Gen HAL example
#  set(CONFIG_USE_component_gen_hal_devicetree true)

#  # description: Generic HAL Init Component
#  set(CONFIG_USE_component_gen_hal_init true)

#  # description: GH dma Driver peripheral specific driver edma
#  set(CONFIG_USE_component_gen_hal_driver_dma_edma true)

#  # description: GH spi Driver peripheral specific driver lpspi
#  set(CONFIG_USE_component_gen_hal_driver_spi_lpspi true)

#  # description: GH i2c Driver peripheral specific driver lpi2c
#  set(CONFIG_USE_component_gen_hal_driver_i2c_lpi2c true)

#  # description: GH counter Driver peripheral specific driver qtmr_1
#  set(CONFIG_USE_component_gen_hal_driver_counter_qtmr_1 true)

#  # description: GH counter Driver peripheral specific driver gpt
#  set(CONFIG_USE_component_gen_hal_driver_counter_gpt true)

#  # description: GH counter Driver peripheral specific driver snvs
#  set(CONFIG_USE_component_gen_hal_driver_counter_snvs true)

#  # description: GH gpio Driver peripheral specific driver igpio
#  set(CONFIG_USE_component_gen_hal_driver_gpio_igpio true)

#  # description: Basic Files/Path for Generic HAL. Needed by each Gen HAL example
#  set(CONFIG_USE_component_gen_hal_basic true)

#  # description: Generic HAL OS Adoption Layer
#  set(CONFIG_USE_component_gen_hal_osa_freertos true)
...
list(APPEND CMAKE_MODULE_PATH
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../components/gen_hal
...
include_if_use(component_ecspi_adapter.MIMXRT1062)
include_if_use(component_eeprom_AT25Fxxxx.MIMXRT1062)
include_if_use(component_eeprom_AT45DBxxxx.MIMXRT1062)
include_if_use(component_eeprom_InternalFlash.MIMXRT1062)
...
include_if_use(component_gen_hal_arch_cm33.MIMXRT1062)
include_if_use(component_gen_hal_arch_cm7.MIMXRT1062)
include_if_use(component_gen_hal_arch_cortexm.MIMXRT1062)
include_if_use(component_gen_hal_basic)
include_if_use(component_gen_hal_devicetree)
include_if_use(component_gen_hal_driver_adc.MIMXRT1062)
include_if_use(component_gen_hal_driver_adc_adc_12b1msps_sar.MIMXRT1062)
include_if_use(component_gen_hal_driver_clock_control.MIMXRT1062)
include_if_use(component_gen_hal_driver_clock_control_ccm.MIMXRT1062)
include_if_use(component_gen_hal_driver_clock_control_syscon.MIMXRT1062)
include_if_use(component_gen_hal_driver_counter.MIMXRT1062)
include_if_use(component_gen_hal_driver_counter_gpt)
include_if_use(component_gen_hal_driver_counter_qtmr_1)
include_if_use(component_gen_hal_driver_counter_snvs)
include_if_use(component_gen_hal_driver_dma.MIMXRT1062)
include_if_use(component_gen_hal_driver_dma_edma)
include_if_use(component_gen_hal_driver_gpio.MIMXRT1062)
include_if_use(component_gen_hal_driver_gpio_igpio)
include_if_use(component_gen_hal_driver_i2c.MIMXRT1062)
include_if_use(component_gen_hal_driver_i2c_lpi2c)
include_if_use(component_gen_hal_driver_pinctrl.MIMXRT1062)
include_if_use(component_gen_hal_driver_pinctrl_imxrt.MIMXRT1062)
include_if_use(component_gen_hal_driver_spi.MIMXRT1062)
include_if_use(component_gen_hal_driver_spi_lpspi)
include_if_use(component_gen_hal_driver_uart.MIMXRT1062)
include_if_use(component_gen_hal_driver_uart_lpuart.MIMXRT1062)
include_if_use(component_gen_hal_init)
include_if_use(component_gen_hal_osa_freertos)
include_if_use(component_gen_hal_soc_MIMXRT1062.MIMXRT1062)
...
include_if_use(component_lpcrtc.MIMXRT1062)
...
include_if_use(component_minispi_adapter.MIMXRT1062)
...
include_if_use(component_vspi_adapter.MIMXRT1062)
...
include_if_use(driver_mdio-common.MIMXRT1062)
include_if_use(driver_mdio-enet.MIMXRT1062)
...
include_if_use(driver_phy-device-ar8031.MIMXRT1062)
include_if_use(driver_phy-device-dp83848.MIMXRT1062)
include_if_use(driver_phy-device-ksz8041.MIMXRT1062)
include_if_use(driver_phy-device-ksz8081.MIMXRT1062)
include_if_use(driver_phy-device-lan8720a.MIMXRT1062)
include_if_use(driver_phy-device-lan8741.MIMXRT1062)
include_if_use(driver_phy-device-rtl8201.MIMXRT1062)
include_if_use(driver_phy-device-rtl8211f.MIMXRT1062)
include_if_use(driver_phy-device-vsc8541.MIMXRT1062)
